...
if(isset($_POST['save']))
{
  ...
  $code=$_POST['code'];
  $sql="insert into tblpoultry_category(CategoryName,CategoryCode)values(:category,:code)";
  ...
  if ($LastInsertId>0) 
  {
    ...
    echo "<script>window.location.href ='poultry_category.php'</script>";
  }
  else
  {
...
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
  $query=mysqli_query($con,"delete from tblpoultry_category where id='$cmpid'");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Poultry Category registration</h5>
              </div>
            ...
            <div class="card">
              ...
              <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblpoultry_category.id,tblpoultry_category.CategoryName,tblpoultry_category.CategoryCode,tblpoultry_category.PostingDate from tblpoultry_category ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();

...
if(isset($_POST['insert']))
{
    ...
    $units =$_POST['units'];
    $price=$_POST['price'];
    $sql4="update tblproducts set CategoryName=:category,ProductName=:product,Units=:units,ProductPrice=:price where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.Units,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.ProductImage from tblproducts where tblproducts.id=:eid";
            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-sm-12 pl-0 pr-0">
                            <input type="text" name="product" value="<?php  echo $row->ProductName;?>" class="form-control" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-sm-12 pl-0 pr-0">Product Units</label>
                        <div class="col-sm-12 pl-0 pr-0">
                            <input type="text" name="units" value="<?php  echo $row->Units;?>" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="row">

...
<div class="card-body">
  <?php
  $eid=$_POST['edit_id5'];
  $sql="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.Units,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.ProductImage from tblproducts  where tblproducts.id=:eid";

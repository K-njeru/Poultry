...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblproducts(CategoryName,ProductName,Units,ProductPrice,ProductImage)values(:category,:product,:units,:price,:image)";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Available Units </label>
                      <input type="text" name="units" value="" placeholder="Enter no. of Units available" class="form-control" id="price"required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Product Price Per Unit </label>
                      ...
                      <div class="col-sm-12 pl-0 pr-0">
                        ...
                        <div class="input-group ">
                          ...
                          <span class="input-group-append">
                            <button class="file-upload-browse btn btn-gradient-primary" value="" type="button">Upload</button>
                          </span>
                        </div>
                      </div>
                    </div> 
                ...
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center"> Product Units</th>
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.Units,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.ProductImage from tblproducts ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;

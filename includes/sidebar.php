 <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#poultrymngt" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">Poultry management</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-archive menu-icon"></i>
            </a>
            <div class="collapse" id="poultrymngt">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="poultry_category.php">Manage Poultry Category</a></li>
                    <li class="nav-item"> <a class="nav-link" href="poultry_mngt.php">Manage Poultry</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
